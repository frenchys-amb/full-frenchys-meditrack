...
export default function ActivityLog() {
  ...
  const handleExportPDF = () => {
    ...
    // ❌ AJUSTADO: Se elimina el logo del encabezado del PDF
    // doc.addImage(logo, "PNG", 10, 8, 18, 18);
    
    doc.setFont("helvetica", "bold");
    doc.setFontSize(16);
    // 💡 AJUSTADO: Se mueve el texto ya que el logo ya no ocupa espacio
    doc.text("Reporte — Registro de Actividades", 10, 16); 
  ...
  return (
    <div className="d-flex">
      <SidebarTop />
        {/* ❌ ELIMINADO: Fondo con logo (marca de agua) */}
        {/* <div
          style={{
            position: "fixed",
            top: "50%",
        ...
        /> */}
        {/* 🎨 Borde difuminado oscuro entre sidebar y contenido (se mantiene) */}
        <div
          style={{
            position: "fixed",
            top: 0,
